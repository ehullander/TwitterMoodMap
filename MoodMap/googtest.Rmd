...
DF<-DF[DF$X!=""&as.numeric(DF$count)>50,]
...
for (n in 1:length(dates))
  ...
  df<-rbind(df, c(X=1300, DMA=1300,scores= -1,sd=0,count=0,Region=0, date=dates[n]))
  df<-rbind(df, c(X=1301, DMA=1301,scores= 1, sd=0,count=0,Region=0, date=dates[n]))
